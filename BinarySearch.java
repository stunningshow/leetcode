...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        while (!StdIn.isEmpty()) {
            int key = StdIn.readInt(); // read every int from the standard input
           
            if (BinarySearch.indexOf(whitelist, key) == -1)
               StdOut.println(key);
            //else StdOut.println(BinarySearch.indexOf(whitelist, key)); print the rank if you want~
        }
    }
}
